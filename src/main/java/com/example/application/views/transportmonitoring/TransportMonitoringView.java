package com.example.application.views.transportmonitoring;
...
@PageTitle("TransportMonitoring")
@Route(value = "monitoring", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
public class TransportMonitoringView extends HorizontalLayout {
    ...
    public TransportMonitoringView() {
        addClassName("transport-monitoring-view");
        setSizeFull();
        setPadding(false);
        setSpacing(false);
